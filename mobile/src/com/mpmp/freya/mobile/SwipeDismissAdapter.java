...
public class SwipeDismissAdapter extends BaseAdapterDecorator {
	...
	private ExpandableListItemAdapter baseAdapter;
     ...
     */
    public SwipeDismissAdapter(final ExpandableListItemAdapter baseAdapter, final OnDismissCallback onDismissCallback) {
     ...
     */
    public SwipeDismissAdapter(final ExpandableListItemAdapter baseAdapter, final OnDismissCallback onDismissCallback, final SwipeOnScrollListener swipeOnScrollListener) {
        super(baseAdapter);
