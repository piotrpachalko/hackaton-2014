...
public class SwipeDismissListViewTouchListener implements SwipeOnTouchListener, ExpandOnTouchListener {
    ...
    private boolean handleDownEvent(final MotionEvent motionEvent) {
        ...
        if (downView != null) {
            ...
            downPosition = AdapterViewUtil.getPositionForView(mListView, downView);
